...
/*
 ...
 Java에서의 Naming Rule(이름규칙)
 	...
 	-메소드명 혹은 변수명 : simpleFunc(), simpleFunc //괄호 있:메소드 ,없:변수
 	-> 소문자로 시작하는 변형된 Camel Case
 	-상수 : SIMPLE_FUNC -> 전체를 대문자로 표현하고,연결된 단어가 있는 경우 _(언더바)를
 			사용한다.
 	-패키지명 : simplefunc -> 전체를 소문자로 표현한다. 연결된 단어가 있더라도
 			언더바를 사용하지 않는다. 언더바 대신 .(닷)으로 표현한다.
 */
