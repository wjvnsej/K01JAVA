...
/*
 ...
 -메소드 호출 후 반환값은 항상 호출한 위치로 반환된다. 이때 메소드는 메모리에서
 소멸된다.
...
public class E01MethodBasic {
	...
	/*
	 ...
	 -> 전달되는 값 없이 이름 입력받은 후 namePrint()함수를 호출한다.
	...
	/*
	 ...
	 매개변수가 있다면 갯수만큼 포함시켜줘야 한다. 매개변수의 갯수가다르면 
	 호출되지 않고 에러가 발생된다.
	 */
	public static void main(String[] args) {
		int result=simpleFunc(1,2); //위에서 simpleFunc는 매개변수가 2개 였다.a,b
		System.out.println("1과 2를 전달한 결과:"+result);
		System.out.println("10과 20을 전달한 결과:"+simpleFunc(10,20));
		
		menuPrint(); // 위에 menuPrint는 매개변수가 없
