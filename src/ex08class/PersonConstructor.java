...
/*
 ...
 -반환값이 없다. 즉 특정 연산 후 값을 반환할 수 없다.
 	따라서 void를 쓸 수없다.
 -그 외는 메소드가 가진 모든 특성을 가지고 있다.(매개변수 전달,오버로딩 등)
 	
 	
생성자 내에서 this의 사용법
용도1 : 동일 클래스 내에서 다른 생성자를 호출 할 때 사용한다.
		단, 생성자 내에서만 호출 가능하다.
		사용법 : 
		this(인자1,인자2,...);
...
public class PersonConstructor {
	...
	public PersonConstructor(String name,int age) {
		/*
		 this() 는 생성자내에서 다른 생성자를 호출할 때 사용하낟.
	...
	void initialize(String name, int age, String addr) {
		...
		//해당 코드(this)는 생성자 내에서만 사용할 수 있다.
		//this(name,age,"미상");
		
		//멤버변수를 구분하기 위한 this는 사용할 수 잇다.
		this.name = name;
		this.age = age;
		this.addr = addr;
	}
