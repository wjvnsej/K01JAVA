	...
	public static void main(String[] args) {
		...
		1-1] 객체저장 : add()메소드
			...
			size() : 컬렉션에 저장된 객체의 객수를 반환한다.
				배열의 크기과 동일하다고 생각하면 된다.
		 */
		list.add("소녀시대");//인덱스0
		list.add("빅뱅");
		list.add("트와이스");
		list.add(3, "워너원");
//		list.add(5, "소방챀ㅋ");//에러발생 인덱스는 건너뛸 수 없다.
		list.add(list.size(), "오마이걸");// <- 4번 인덱스에 입력
		...
		/*
		Iterator 사용법
		- 컬렉션에 저장된 내용을 Iterator에게 알려주기 위ㅏ해
			객체를 생성한다.
		- hasNext()메소드로 반환 할 객체가 있는지 검사하고,
