...
/*
 while문
 	...
 	반복문이다. 반복의 횟수가 명확할때는 주로 for문을 사용한다.
 	형식]
 		반복을 위한 변수의 초기값 선언;
 		while(반복의 조건){
 			실행문;
 			변수의 증감식; <= 반복문 탈출을 위한 ++ , -- 와 같은 연산이 필요함.
 		}
...
public class E03While {
	...
	public static void main(String[] args) {
		...
		/*
		 시나리오] 1부터 100까지의 정수 중 3의 배수이거나 5의 배수인 수의 합을 구하여 
		 출력하는 프로그램을 while을 사용해서 작성하시오.
		 */
		int total=0;
		int j=1;
		while(j<=100) {
		...
		while(dan<=9) { //단은 2~9까지 증가함
			int su=1;//수(하나의 단을 출력한 후에 단이 증가하면 수는 1로 초기화)
