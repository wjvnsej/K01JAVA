...
//		}
		...
		/*
		 ...
		 '세미콜론'은 문장의 끝을 나타내므로 사용에 주의해야한다.
		 */
		if(num%2 !=0);
		{
		...
		/*
		 조건검사 후 실행 할 문장이 하나인 경우에는 {} 중괄호를 생략할 수 있다.
		...
		/*
		 System.in.read();
		 	: 사용자에게 하나의 문자를 입력받을때 사용하는 메소드로 입력한
		 	문자의 아스키코드값을 반환한다.
...
//		System.out.println("입력한 문자:"+(char)asciiCode);
		...
		/*
		 ...
		 ※숫자의 구간을 정할 때는 반드시 논리AND(&&)를 사용해야 한다.
		 */
