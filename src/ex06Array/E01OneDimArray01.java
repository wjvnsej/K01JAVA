...
public class E01OneDimArray01 {//Dim = dimention차원
	...
	public static void main(String[] args) {
		...
		/*
		 객체배열
		 	: 기본자료형을 저장하는배열이 아니라, 객체의 참조값을 저장할
		 	용도로 생성하는 배열이다. 사용방법은 동일하다.
		 */
	...
	/*
	 배열의 선언과 동시에 초기화를 하는 경우 자바 컴파일러는 초기기값의 갯수를 통해 크기를
	 결정할 수 있으므로 이런경우 크기는 생략하도록 약속되어있다.
	 */
