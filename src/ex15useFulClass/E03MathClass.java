...
- 메소드는 static으로 선언되어 객체생성 없이 사용 가능
 */
public class E03MathClass extends Object{
	...
	public static void main(String[] args) {
		...
		/*
		반올림 : 무조건 소수점 첫 번째 자리에서 반올림 처리한다.
		 */
		System.out.println("### 반올림 ###");
		System.out.println("Math.round : " + Math.round(3.4999));//버림처리
		System.out.println("Math.round : " + Math.round(3.5444));//올림처리
