...
public class Ex02PreDefineException {
	...
	public static void main(String[] args) {
		...
		: 배열의 크기를 벗어난 인덱스를 사용 할 때 발생되는 예외
		 */
		System.out.println
		...
		try {
			...
			printStackTrace : 예외가 발생할 때의 에러메세지를
				그대로 콘솔에 출력해줌. 개발시 훨신 더 사용빈도 높음.
			 */
		...
		System.out.println
		("== ArrayIndexOutOfBoundsException발생 후 ==");
		...
		: 숫자를 입력해야 하는데 문자열을 입력 할 때 발생되는 예외
		 */
		...
		4] NullPointerException
			...
			발생되는 예외. 즉 참조변수만 생성되고, 참조 할
			객체가 없는 상태에서 사용했을때 발생하게된다.
		 */
	...
	/*
	String 객체가 매개변수로 전달되면서 Object로 형 변환 되기 
