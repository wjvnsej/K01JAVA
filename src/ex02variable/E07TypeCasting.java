...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		 아래코드는 자동형변환이 아님. CPU는 int 보다 작은 자료형을 int로 간주하고
		 연산을 진행하며, 결과도 int로 반환한다.
		 CPU의 특성이라 생각하자.
		 */
		...
		/*
		 명시적 형변환 : 큰상자의 자료를 작은상자의 자료형에 할당해야할 때 사용한다.
		...
		/*
		 char와 int를 연산하면 결과는 int를 반환하므로 char형 변수에 대입하려면
		 명시적 형변환 후 해야한다.
		 */
