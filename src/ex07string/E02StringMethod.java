	...
	public static void main(String[] args) {
		...
		/*
		 9]format()
		 	 ...
		 	 printf()와 사용법은 동일하고 주로 웹어플리케이션(JSP)를 제작할 때 사용된다.
		 */
		 ...
		 */
			...
			/*
			 11]lastIndexOf()
			 	...
			 	문자열을 찾아서 인덱스를 반환한다.
			 */
				System.out.println(str1.lastIndexOf("ava"));//str1("Welcome to java)
				System.out.println(str1.lastIndexOf("J"));
				System.out.println("indexOf"+str1.indexOf("a"));//java 앞의 a의 인덱스를 먼저 찾음 = 12
				System.out.println("lastIndexOf:"+str1.lastIndexOf("a"));//java 뒤의 a의 인덱스를 먼저 찾음 = 14
				...
				System.out.println(str1.replace("J", "G"));//대문자 J가 없어서 변화없음
				System.out.println("java를 KOSMO로 변경하기");
				System.out.println(str1.replace("java", "KOSMO"));//java => KOSMO로 변경됨
				
				/*
				 split
				 	: 문자열을 구분자를 통해 분리해서 String타입의 배열로 반환한다.
				 	해당 구분자가 없는 경우에는 크기가 1인 String 배열로 반환한다.
				 */
